export default function Header(){
    return(
        <header className="w-[80%] mt-6 font-jeju flex items-center justify-between h-[52px] p-[18px] border-s-[#197686] box-border rounded-[24px] bg-[rgba(5,_37,_44,_0.40)] ">
            ...
            <button className="w-[151px] my-[16px] mx-[24px] cursor-pointer h-[40px] border-[1px] rounded-[12px] border-[rgba(213,_234,_0,_0.10)] outline-none text-[#0A0C11] text-[16px] font-[400] font-jeju bg-[white] flex items-center justify-center gap-2  ">MY TICKETS <img src="/arrow.png" alt="arrow" /></button>
        </header>
    )
}