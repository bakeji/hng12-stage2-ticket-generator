    ...
    return(
        ...
        <div className="flex items-start flex-col justify-center w-[100%] ">
            <div className="flex items-center  justify-between w-[100%]">
                <h1 className= "text-[#ffffff] font-jeju font-[400] text-[32px]">Attendee Details</h1>
                <p className= "text-[#ffffff] font-jeju font-[400] text-[16px]">Step 2/3</p>
            </div>
            ...
            <div className="w-[100%] mt-[20px] p-[24px] border-[#0E464F] bg-[#08252B] rounded-[32px]">
                <div className="w-[100%] p-[24px] rounded-[24px]  border-[#07373F] border-[1px] flex flex-col item-center justify-center gap-[10px]">
                    <p className="font-roboto text-[16px] font-[400] mb-[30px] text-[#FAFAFA]">Upload Profile Photo</p>
                    <div className="h-[200px] mt-[20px] w-[100%] mb-[30px] bg-[rgba(0,_0,_0,_0.20)] flex-col items-center justify-center ">
                        ...
                        {pictureUrl && ! <img src="/cloud.png" alt="cloud" />}
                           {pictureUrl &&
                            <img className=" w-[240px] h-[270px] rounded-[32px]" src={pictureUrl} alt="picture" />
                           }
                            <input 
                            onChange={handleFile}
                            type="file" 
                             className="opacity w-[100%] absolute h-[100%] opacity-0 " name="img" id="pic" accept="image/png, image/jpeg" />
                        {pictureUrl && !<label className="text-center relative font-roboto text-[16px] font-[400] text-[#FAFAFA] w-[80%]">Drag & drop or click to upload</label>}
                        </div>
                    </div>
                ...
                <div className="mt-[20px] flex flex-col gap-[10px] text-[#FAFAFA]">
                    <div className="flex flex-col gap-[10px]">
                        <label className="font-roboto text-[16px] font-[400]" htmlFor="name">Enter your name</label>
                        <input 
                    ...
                    <div className="flex flex-col gap-[10px]">
                        <label className="font-roboto text-[16px] font-[400]"  htmlFor="email">Enter your email *</label>
                        <input className="h-[48px] w-[100%] rounded-[12px] outline-none p-5 border-[#07373F] border-[1px] "
                         type="email" 
                         name="email" 
                         id="email"
                    ...
                    <div className="flex flex-col gap-[10px]">
                        <label className="font-roboto text-[16px] font-[400]" htmlFor="text">Special request?</label>
                        <textarea 
                ...
                <button className="w-[50%] h-[38px] bg-[transparent] font-[400] text-[#24A0B5] text-[16px] outline-none border-[1px] border-[#24A0B5] rounded-[8px]">Back</button>
                <button onClick={nextPage} className="w-[50%] h-[38px] bg-[#24A0B5] font-[400] text-[#ffffff] text-[16px] outline-none border-[1px] border-[#24A0B5] rounded-[8px]">Get My {selectedTicket.ticket} Ticket</button>
            </div>
