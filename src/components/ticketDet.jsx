  ...
  return (
    <div className="w-[37%] mt-[40px] mb-[30px] h-max p-[20px] border-[#0E464F] rounded-[40px] border-[1px] max-lg:w-[60%] max-md:w-[80%] max-sm:w-[90%] max-xs:w-[97%]">
      ...
      <div className="flex items-center mt-[5px] text-white text-center justify-center flex-col gap-1">
        <h1 className="font-alatsi font-[400] text-[32px]">
          Your Ticket is Booked!
        </h1>
        <p className="font-roboto text-[16px] font-[400]">
          Check your email for a copy or you can{" "}
          <span className="font-[700]">download</span>
        </p>
      </div>

      <div className="mt-[25px] w-[66%] p-[20px] bg-transparent bg-cover bg-center h-[600px] bg-no-repeat bg-[url(/ticket.png)]  mx-auto flex items-center flex-col max-sm:w-[94%] max-sm:h-[620px] ">
        <div className="rounded-[16px] w-[100%]  border-[#24A0B5]  border-[1px] backdrop-blur-[2px] bg-[rgba(3,_30,_33,_0.10)] ">
          <div className="flex flex-col items-center justify-center mt-[5px] text-white">
            <h1 className="font-rage font-[400] text-[34px]">
              Techember Fest ”25
            </h1>
            <p className="font-roboto text-[10px] font-[400]">
          ...
          <div className="w-[140px] h-[140px] mx-auto my-[20px] flex ">
            <img
              src={pictureUrl}
              className="w-[140px] height[140px] border-[#24A0B580] border-[4px] rounded-[12px] "
              alt="picture"
            />
          </div>
          ...
          <div className="w-[90%]  mb-[10px] rounded-[8px] mx-[auto] border-[1px] bg-[#08343C] flex flex-col gap-1 border-[#133D44]">
            ...
            <div className="flex flex-col h-[49px]  ">
              <p className="font-roboto mt-[2px] p-[2px] text-[10px]  font-[400] text-[#FFFFFF] opacity-[0.33]">
                Special request?
              </p>
        ...
        <img
          className="mt-[45px] max-sm:mt-[80px]"
          src="/barcode.png"
          alt="barcode"
        />
      </div>
      ...
      <div className="mt-[20px] flex items-center justify-center gap-[20px] max-sm:flex-col">
        <button
          ...
          className="cursor-pointer w-[50%] h-[48px] bg-[transparent] font-[400] text-[#24A0B5] text-[16px] outline-none border-[1px] border-[#24A0B5] rounded-[8px] max-sm:w-[100%]"
        >
          {" "}
          Book Another Ticket
        </button>
